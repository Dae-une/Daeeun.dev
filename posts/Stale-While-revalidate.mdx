...
<img src="https://youthfulhps.dev/static/f9e7bb4b3dee1eadcc36789a1ce9936b/9cab2/swr-flow-1.png" />

HTTP요청이 1 ~ 60초(max-age~ swr)사이에 반복적으로 발생할 경우,
우선 캐싱된 낡은 컨텐츠를 반환하고, 이와 동시에 캐싱된 컨텐츠를 새로운 컨텐츠로 채우도록 재검증 요청이 발생합니다.

<img src="https://youthfulhps.dev/static/4cfd14b60aa1d85a5dc28e2a9770979f/9cab2/swr-flow-2.png" />
